...
import appBumper from "../../public/logo.png";
        ...
        <header className="flex">
          <section className="w-[100%] max-h-screen h-[45.5rem] bg-[#D3D3D3] flex flex-col ">
            <div className="w-[39.25rem] m-auto">
              <Image src={appBumper} alt="" className="mb-[5.12rem]"/>
        ...
        <section className="flex">
          <section className="flex flex-col bg-[#E3E3E3] w-full">
            ...
            <div className="w-[39.25rem] mx-auto">
              ...
              <p className="text-[0.875rem] text-[#828282] leading-[2rem] mt-[2rem]"><strong>A Ready To Go</strong> compartilhará os dados pessoais do titular para a plataforma Hotmart, a mesma que realiza a ativação do <strong>AppBumper.</strong></p>
            ...
            <div className="w-[39.25rem] mx-auto">
              ...
              <p className="text-[0.875rem] text-[#828282] leading-[2rem] mt-[2rem]">1. Seus dados coletados serão compartilhados com a plataforma HOTMART, a mesma que realizou a compra/ativação AppBumper.</p>
